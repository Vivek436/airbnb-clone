...
const ListingPage3 = () => {
  ...
  console.log(handleAddListing,"fsjafhaskhf")
  ...
  return (
    <div className="w-[100%] h-[100vh] flex items-center justify-center gap-[10px] flex-col overflow-auto relative">
      ...
      <div className="w-[95%] h-[400px] flex items-center justify-center flex-col md:w-[80%] md:flex-row  ">
        <div className="w-[100%] h-[65%] md:w-[70%] md:h-[100%] overflow-hidden felx items-center justigy-center border-[2px] border-[white] ">
      ...
      <div className="w-[95%] flex items-start justify-start text-[18px] md:w-[80%] md:text-[25px] text-gray-800">{`${discription.toUpperCase()}`}</div>
      <div className="w-[95%] flex items-start justify-start text-[18px] md:w-[80%] md:text-[25px]">{`${rent}/day `}</div>
      <div className="w-[95%] h-[50px] flex items-center justify-start px-[110px]">
        <button
          className="px-[50px] py-[10px] text-[white] bg-[red] text-[18px] md:px-[100px] rounded-lg cursor-pointer"
