    ...
    <div className="w-[100%] h-[100vh] bg-white flex items-center justify-center relative overflow-auto">
      ...
      >
        ...
        <div className="w-[90%] flex items-start justify-start flex-col gap-[10px] ">
          ...
          <input
            ...
            required onChange={(e)=>setTitle(e.target.value)} value={title} placeholder="_bhk house pr best title"
          />
        </div>
        <div className="w-[90%] flex items-start justify-start flex-col gap-[10px] ">
          ...
          <textarea
            ...
            required onChange={(e)=>setDiscription(e.target.value)} value={discription} placeholder="_bhk house pr best Discription"
          ></textarea>
        </div>
        ...
        <div className="w-[90%] flex items-start justify-start flex-col gap-[10px] ">
          ...
          <input
            type="file"
            id="img1"
            className="w-[100%]  text-[15px] px-[10px]"required onChange={handleImage1}
            />
            </div>
        </div>
        ...
        <div className="w-[90%] flex items-start justify-start flex-col gap-[10px] ">
          ...
          <input
            type="file"
            id="img2"
            className="w-[100%]  text-[15px] px-[10px]"required onChange={handleImage2}
            />
            </div>
        </div>
        ...
        <div className="w-[90%] flex items-start justify-start flex-col gap-[10px] ">
          ...
          <input
            type="file"
            id="img3"
            className="w-[100%]  text-[15px] px-[10px]"required onChange={handleImage3}
            />
            </div>
        </div>
      ...
      <div className="w-[90%] flex items-start justify-start flex-col gap-[10px] ">
          ...
          <input
            ...
            id="rent"
            className="w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg p-[20px]"
            required onChange={(e)=>setRent(e.target.value)} value={rent} placeholder="Rs.__________/day"
          />
        </div>
        ...
        <div className="w-[90%] flex items-start justify-start flex-col gap-[10px] ">
          ...
          />
                ...
                <button className='px-[50px] py-[10px] text-[white] bg-[red] text-[18px] md:px-[100px] rounded-lg cursor-pointer'>Next</button>
      </form>
    </div>
  );
};
